...
Source: "node_modules\*"; DestDir: "{app}\node_modules"; Flags: ignoreversion recursesubdirs createallsubdirs; Excludes: ".git*,*.md,*.txt,*.log"
Source: "package.json"; DestDir: "{app}"; Flags: ignoreversion

[Icons]
Name: "{group}\Bulgarche Desktop"; Filename: "{app}\bulgarche-launcher.bat"; IconFilename: "{app}\icon\bulgarche-icon.png"; Comment: "Learn Bulgarian with Bulgarche"
Name: "{group}\{cm:UninstallProgram,Bulgarche Desktop}"; Filename: "{uninstallexe}"
Name: "{commondesktop}\Bulgarche Desktop"; Filename: "{app}\bulgarche-launcher.bat"; IconFilename: "{app}\icon\bulgarche-icon.png"; Tasks: desktopicon; Comment: "Learn Bulgarian with Bulgarche"
Name: "{userappdata}\Microsoft\Internet Explorer\Quick Launch\Bulgarche Desktop"; Filename: "{app}\bulgarche-launcher.bat"; Tasks: quicklaunchicon; IconFilename: "{app}\icon\bulgarche-icon.png"

[Run]
Filename: "{app}\bulgarche-launcher.bat"; Description: "Launch Bulgarche Desktop"; Flags: nowait postinstall skipifsilent unchecked
