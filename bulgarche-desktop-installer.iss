...
Source: "bulgarche-desktop.bat"; DestDir: "{app}"; Flags: ignoreversion
...
[Icons]
Name: "{group}\Bulgarche Desktop"; Filename: "{app}\bulgarche-desktop.bat"; IconFilename: "{app}\icon\bulgarche-icon.png"; Comment: "Learn Bulgarian with Bulgarche"
Name: "{group}\{cm:UninstallProgram,Bulgarche Desktop}"; Filename: "{uninstallexe}"
Name: "{commondesktop}\Bulgarche Desktop"; Filename: "{app}\bulgarche-desktop.bat"; Tasks: desktopicon; Comment: "Learn Bulgarian with Bulgarche"
Name: "{userappdata}\Microsoft\Internet Explorer\Quick Launch\Bulgarche Desktop"; Filename: "{app}\bulgarche-desktop.bat"; Tasks: quicklaunchicon; IconFilename: "{app}\icon\bulgarche-icon.png"

[Run]
Filename: "{app}\bulgarche-desktop.bat"; Description: "Launch Bulgarche Desktop"; Flags: nowait postinstall skipifsilent unchecked
