@echo off
cd /d "%~dp0"
title Build Bulgarche ISS Installer
...
if not exist "bulgarche-final.iss" (
  echo ERROR: bulgarche-final.iss not found
  pause
  exit /b 1
)
...
echo - Native desktop launcher (bulgarche-launcher.exe)
echo.
pause
